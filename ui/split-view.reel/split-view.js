 ...
 * @extends Component
 */
exports.SplitView = AbstractSlider.specialize(/** @lends SplitView# */ {

    // Lifecycle
    constructor: {
        value: function SplitView() {
            this.super();
    ...
    valuePercentage: {
        set: function (value) {
            if (this._valuePercentage !== value) {
                ...
                if(this.identifier === "verticalSplit") {
                    console.log("verticalSplit", "valuePercentage", this._valuePercentage)
                }
                this.needsDraw = true;
            }
        },
